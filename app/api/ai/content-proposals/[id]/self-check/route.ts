...
import { AiContentWorkflowError, rerunAiContentSelfCheck } from "@/lib/server-ai-content";
...
export async function POST(
  ...
  try {
    const proposal = await rerunAiContentSelfCheck(auth.context.supabase, auth.context.user.id, id);
