...
export function BilibiliPlayer({ bvid, cid, p = 1, title, autoPlay = false, inlineMode = false, onExitInline }: BilibiliPlayerProps) {
  ...
  // If in inline mode, render a simpler player without controls
  if (inlineMode) {
    return (
      <div
        ref={containerRef}
