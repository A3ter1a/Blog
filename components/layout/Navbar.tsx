  ...
  return (
    ...
    >
      <div className="mx-auto grid h-20 max-w-7xl grid-cols-[minmax(8rem,1fr)_auto_minmax(8rem,1fr)] items-center gap-3 px-4 sm:px-6 md:px-8 lg:grid-cols-[minmax(11rem,1fr)_auto_minmax(11rem,1fr)] lg:px-10">
        ...
        <Link
          href="/"
          className="flex min-w-0 items-center gap-2 justify-self-start rounded-lg transition-all duration-300 ease-out hover:opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
        >
          <Image
            src="/logo.png"
            alt="Asteroid Logo"
          ...
          {visibleNavItems.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                className={`relative whitespace-nowrap rounded-lg px-1 py-2 font-headline text-base font-medium transition-all duration-300 ease-out after:pointer-events-none after:absolute after:-bottom-1 after:left-1/2 after:h-px after:-translate-x-1/2 after:rounded-full after:bg-primary-container after:transition-all after:duration-300 after:ease-out focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 lg:text-lg ${
                  isActive
        ...
        <div className="flex items-center justify-end gap-1.5 justify-self-end sm:gap-2">
          ...
          <button
            ...
            className="rounded-lg p-2 text-primary-container transition-all duration-300 ease-out hover:bg-surface-container-high focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
            aria-label="搜索"
          >
          ...
          <button
            ...
            className="rounded-lg p-2 text-primary-container transition-all duration-300 ease-out hover:bg-surface-container-high focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 md:hidden"
            aria-label="打开导航"
          ...
          >
            <div className="mb-2 flex items-center justify-between gap-3 px-2 py-1">
              ...
              <button
                type="button"
                onClick={() => setShowMobileMenu(false)}
                className="flex h-9 w-9 items-center justify-center rounded-lg text-on-surface-variant transition-all duration-300 ease-out hover:bg-surface-container-high hover:text-primary"
                aria-label="关闭导航"
              >
                <X className="h-5 w-5" />
              </button>
              ...
              {visibleNavItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.href}
                    href={item.href}
                    className={`flex items-center gap-3 rounded-lg px-3 py-3 text-sm font-medium transition-all duration-300 ease-out focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 ${
                      isActive
